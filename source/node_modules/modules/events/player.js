    ...
    sw.on('player-ready', function() {
      ...
      function _handleTrackPlayback(track) {
        ...
        if (stream_url !== '') {
          ...
          sw.display.getElement('background').css('background-image', `url(${track.getArtworkUrl(Artwork.SIZE_500)})`);
      ...
      _audio.on('timeupdate', function(jqEvent) {
        ...
        if (sw.player.getNativeAudio().src && sw.player.isPaused() === false) {
