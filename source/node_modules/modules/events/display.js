...
module.exports = {
  register: function() {
    ...
    sw.display.on('update-artwork', function(value) {
      ...
      sw.display.getElement('sw.display.artwork').css('background-image', `url(${value})`);
    });

    sw.display.on('update-background-artwork', function(value) {
      sw.display.getElement('sw.display.background.artwork').css('background-image', `url(${value})`);
    });
