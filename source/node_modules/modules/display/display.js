...
Display.prototype.setSubTitle = function(value) {
  this._mainTitle = value;
  this.emit('update-sub-title', value);
  return this;
};
...
Display.prototype.setBackgroundArtwork = function(value) {
  this._background_artwork = value;
  this.emit('update-background-artwork', value);
  return this;
};

Display.prototype.getBackgroundArtwork = function() {
  return this._background_artwork;
};
...
Display.prototype.getElement = function(key) {
  return $('[data-id="' + key + '"]');
}
